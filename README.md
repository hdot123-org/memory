...
```bash
pip install git+https://github.com/hdot123/memory.git@v0.9.5
```

Upgrade to a new version:

```bash
pip install --upgrade git+https://github.com/hdot123/memory.git@v0.9.5
```

Install from release wheel:

```bash
gh release download v0.9.5 --repo hdot123/memory --pattern "*.whl"
pip install memory_core-0.9.5-py3-none-any.whl
```
