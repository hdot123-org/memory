...
## Architecture (v0.13.4) <!-- x-release-please-version -->
...
## Telemetry Architecture (v0.13.4) <!-- x-release-please-version -->
...
```bash
pip install git+https://github.com/hdot123/memory.git@v0.13.4 <!-- x-release-please-version -->
```

Upgrade to a new version:

```bash
pip install --upgrade git+https://github.com/hdot123/memory.git@v0.13.4 <!-- x-release-please-version -->
```

Install from release wheel:

```bash
gh release download v0.13.4 --repo hdot123/memory --pattern "*.whl" <!-- x-release-please-version -->
pip install memory_core-0.13.4 <!-- x-release-please-version -->
```
...
- Current documented release: v0.13.4 <!-- x-release-please-version -->
- Python: >= 3.9
