...
## 架构 (v0.47.1) <!-- x-release-please-version -->
...
## 遥测架构 (v0.47.1) <!-- x-release-please-version -->
...
```bash
pip install git+https://github.com/hdot123-org/memory.git@v0.47.1 <!-- x-release-please-version -->
```

升级到新版本：

```bash
pip install --upgrade git+https://github.com/hdot123-org/memory.git@v0.47.1 <!-- x-release-please-version -->
```

从 release wheel 安装：

```bash
gh release download v0.47.1 --repo hdot123-org/memory --pattern "*.whl" <!-- x-release-please-version -->
pip install memory_core-0.47.1 <!-- x-release-please-version -->
```
...
- 当前文档版本：v0.47.1 <!-- x-release-please-version -->
- Python: >= 3.9
