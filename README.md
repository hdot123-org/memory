...
```bash
pip install git+https://github.com/hdot123/memory.git@v0.9.3
```

Upgrade to a new version:

```bash
pip install --upgrade git+https://github.com/hdot123/memory.git@v0.9.3
```

Install from release wheel:

```bash
gh release download v0.9.3 --repo hdot123/memory --pattern "*.whl"
pip install memory_core-0.9.3-py3-none-any.whl
```
...
- Current documented release: v0.9.3
- Python: >= 3.9
