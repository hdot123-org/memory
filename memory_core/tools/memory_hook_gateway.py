...
# ---------------------------------------------------------------------------
# _gateway_config — 路径常量、适配器存储、IF-5 门面、完整性
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# _gateway_artifacts — artifact 写入、只读 source-repo package
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# _gateway_policy — core builder、业务策略、build_context_package
# ---------------------------------------------------------------------------
