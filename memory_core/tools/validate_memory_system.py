...
def check_context_package(result: ValidateResult, builder: Any) -> bool:
    ...
    try:
        ...
        kwargs = dict(
            ...
            required_canonical=gw.get_config("REQUIRED_CANONICAL"),
            project_canonical=gw.get_config("PROJECT_CANONICAL"),
            project_runtime_root=gw.get_config("PROJECT_RUNTIME_ROOT"),
            global_canonical=gw.get_config("GLOBAL_CANONICAL"),
            project_map_governance=gw.get_config("PROJECT_MAP_GOVERNANCE"),
            event_log=gw.EVENT_LOG,
            legality_source_policy=gw.get_config("LEGALITY_SOURCE_POLICY"),
            registration_commit_policy=gw.get_config("REGISTRATION_COMMIT_POLICY"),
            registration_commit_phase=gw.get_config("REGISTRATION_COMMIT_PHASE"),
            project_map_refs=[],
            ...
            hook_contract_path=gw.get_config("HOOK_CONTRACT_PATH"),
            surface_id="",
            workspace_id="",
