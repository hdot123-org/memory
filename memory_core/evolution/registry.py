...
class EvolutionRegistry:
    ...
    def __init__(self, lifecycle_root: Optional[Path] = None):
        """
        初始化注册表
    ...
    def _read_path_index(self) -> List[Optional[Path]]:
        ...
        try:
            ...
            roots = []
            for path_str, info in paths_dict.items():
    ...
    def _read_projects_dir(self) -> List[Optional[Path]]:
