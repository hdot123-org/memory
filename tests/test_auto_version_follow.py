...
class TestDowngradeBlocked:
    ...
    def test_downgrade_blocked(self, tmp_path: Path) -> None:
        ...
        from infra_core.engine.version_sync import _gate_version_bump, sync_single_project

        from memory_core.constants import CURRENT_MEMORY_VERSION as CMV
        ...
        # Integration test: full sync_single_project (re-exported from infra_core)
        ...
        result = sync_single_project(project, CMV)
...
class TestGatewayVersionDetection:
    ...
    def test_detect_version_probe_function_exists(self) -> None:
        """The probe_version_and_sync function should be available via infra_core."""
